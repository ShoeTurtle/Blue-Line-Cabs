VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} DriverReport 
   Bindings        =   "DriverReport.dsx":0000
   Caption         =   "Blue-Line DriverReport"
   ClientHeight    =   11010
   ClientLeft      =   60
   ClientTop       =   450
   ClientWidth     =   15240
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Blue-Line Driver Report"
         Alignment       =   2
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   BeginProperty Section2 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item14 {1C13A8E2-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         DataField       =   "DRIVER_LICENCE_VALIDITY"
         BeginProperty DataFormat {6D835690-900B-11D0-9484-00A0C91110ED} 
            Type            =   0
            Format          =   ""
            HaveTrueFalseNull=   0
   ...
   EndProperty
End
Attribute VB_Name = "DriverReport"
